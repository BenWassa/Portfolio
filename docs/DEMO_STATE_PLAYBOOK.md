...
> Imported verbatim from `hearth_v2/docs/DEMO_STATE_PLAYBOOK.md` on 2026-09-13 and adopted
> as this repo's standard for what qualifies a project for a `demoUrl` iframe embed. See
> `CLAUDE.md` §5 and `docs/open/PORTFOLIO-REFRESH-PLAN.md` Phase 3.
