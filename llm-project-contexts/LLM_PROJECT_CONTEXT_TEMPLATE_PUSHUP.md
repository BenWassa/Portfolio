# PushUp Challenge LLM Project Context (template-pushup)

Use this as `LLM_CONTEXT.md` when handing PushUp Challenge to another LLM.

## 1) Project Snapshot
- Project name: PushUp Challenge
- One-line description: Template/staging branch for evolving challenge mechanics and UX patterns before mainline updates.
...
## 2) Purpose and Scope
- Problem this project solves: Creates a safe sandbox for feature iteration in challenge logic and interface design without impacting active participants.
- Target users: Maintainers testing challenge-mode refinements and seasonal feature updates.
...
- Production app: 
- Staging app: N/A
- Repository: https://github.com/BenWassa/template-pushup
- Main branch: https://github.com/BenWassa/template-pushup/tree/main
- Active working branch: https://github.com/BenWassa/template-pushup/tree/main
- Docs: https://github.com/BenWassa/template-pushup/blob/main/README.md
- Design files: N/A
- Issue tracker / board: https://github.com/BenWassa/template-pushup/issues
...
```text
You are helping on PushUp Challenge template repo (template-pushup).
...
- Public tagline: Stress-test the challenge UX before release.
