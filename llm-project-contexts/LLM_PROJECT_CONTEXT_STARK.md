# STARK LLM Project Context (STARK)

Use this as `LLM_CONTEXT.md` when handing STARK to another LLM.

## 1) Project Snapshot
- Project name: STARK
- One-line description: A fitness intelligence dashboard that turns physiological signals into clean, interpretable insight.
- Current status: `prototype`
- Primary owner: Benjamin Haddon
- Last updated (YYYY-MM-DD): 2026-02-18

## 2) Purpose and Scope
- Problem this project solves: Health metrics are often fragmented, noisy, and hard to integrate into meaningful decisions.
- Target users: Data-aware trainees focused on strength, endurance, recovery, and long-term performance.
- Core outcomes / success criteria:
  - Unify metrics into a coherent fitness index.
  - Surface trends without overwhelming charts.
  - Keep calculations transparent and user-controlled.
- In scope:
  - Client-side calculations and visualization.
  - Offline-capable PWA delivery.
  - Readable trend and baseline comparisons.
- Out of scope:
  - Medical device claims.
  - Opaque proprietary scoring.

## 3) Links (Use Full URLs)
- Production app: https://benwassa.github.io/STARK/
- Staging app: N/A
- Repository: https://github.com/BenWassa/STARK
- Main branch: https://github.com/BenWassa/STARK/tree/main
- Active working branch: https://github.com/BenWassa/STARK/tree/main
- Docs: https://github.com/BenWassa/STARK/blob/main/README.md
- Design files: N/A
- Issue tracker / board: https://github.com/BenWassa/STARK/issues
...
```text
You are helping on STARK (STARK).
...
- Public tagline: Physiology, translated into decisions.
...
- Resume bullet: Built and iterated STARK as a focused product with strong UX intent and technical clarity
