# Sankofa LLM Project Context (sankofa)

Use this as `LLM_CONTEXT.md` when handing Sankofa to another LLM.

## 1) Project Snapshot
- Project name: Sankofa
- One-line description: A narrative research platform for rebuilding meaning through myth, culture, and psychological depth.
- Current status: `active`
- Primary owner: Benjamin Haddon
- Last updated (YYYY-MM-DD): 2026-02-18

## 2) Purpose and Scope
- Problem this project solves: Modern audiences face fragmented meaning systems and need coherent frameworks that are both rigorous and human.
- Target users: Readers and listeners exploring purpose, culture, and psychological transformation.
- Core outcomes / success criteria:
  - Unify research and narrative in one coherent framework.
  - Create a durable base for long-form media output.
  - Balance intellectual clarity with emotional resonance.
- In scope:
  - Narrative essays, conceptual frameworks, and media scaffolding.
  - Cross-linking between themes and companion projects.
  - Readable structure for progressive exploration.
- Out of scope:
  - Hot-take news commentary.
  - Algorithmic engagement optimization.

## 3) Links (Use Full URLs)
- Production app: https://benwassa.github.io/sankofa/
- Staging app: N/A
- Repository: https://github.com/BenWassa/sankofa
- Main branch: https://github.com/BenWassa/sankofa/tree/main
- Active working branch: https://github.com/BenWassa/sankofa/tree/main
- Docs: https://github.com/BenWassa/sankofa/blob/main/README.md
- Design files: N/A
- Issue tracker / board: https://github.com/BenWassa/sankofa/issues
...
```text
You are helping on Sankofa (sankofa).
...
- Public tagline: A living framework for the modern meaning crisis.
...
- Resume bullet: Built and iterated Sankofa as a focused product with strong UX intent and technical clarity
