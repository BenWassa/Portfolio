# Wrestle LLM Project Context (wrestlePWA)

Use this as `LLM_CONTEXT.md` when handing Wrestle to another LLM.

## 1) Project Snapshot
- Project name: Wrestle
- One-line description: An offline-first wrestling training log built for honesty, structure, and long-term progression.
- Current status: `active`
- Primary owner: Benjamin Haddon
- Last updated (YYYY-MM-DD): 2026-02-18

## 2) Purpose and Scope
- Problem this project solves: Athletes need reliable training records without logins, distraction, or data lock-in.
- Target users: Wrestlers and grapplers tracking sessions, drills, and personal development.
- Core outcomes / success criteria:
  - Capture practice data fast.
  - Expose trends over time.
  - Protect privacy through local-first design.
- In scope:
  - Technique/session logging.
  - Trend review and analytics snapshots.
...
- Production app: https://benwassa.github.io/wrestlePWA/
- Staging app: N/A
- Repository: https://github.com/BenWassa/wrestlePWA
- Main branch: https://github.com/BenWassa/wrestlePWA/tree/main
- Active working branch: https://github.com/BenWassa/wrestlePWA/tree/main
- Docs: https://github.com/BenWassa/wrestlePWA/blob/main/README.md
- Design files: N/A
- Issue tracker / board: https://github.com/BenWassa/wrestlePWA/issues

## 4) Tech Stack
### Frontend
- Framework: Vanilla JS / static
- Language: JavaScript
- Styling: CSS
...
```text
You are helping on Wrestle (wrestlePWA).
...
- Public tagline: Built for mat time, not screen time.
...
- Resume bullet: Built and iterated Wrestle as a focused product with strong UX intent and technical clarity
