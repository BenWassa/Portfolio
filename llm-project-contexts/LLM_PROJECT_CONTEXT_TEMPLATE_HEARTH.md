# Hearth LLM Project Context (template-hearth)

Use this as `LLM_CONTEXT.md` when handing Hearth to another LLM.

## 1) Project Snapshot
- Project name: Hearth
- One-line description: Template branch of Hearth for controlled iteration and safe experimentation before production merges.
- Current status: `prototype`
- Primary owner: Benjamin Haddon
- Public access mode: `public_template` (template showcase variant for safe public/demo usage)
- Last updated (YYYY-MM-DD): 2026-02-19

## 2) Purpose and Scope
- Problem this project solves: Provides a protected staging surface to evolve shared-watchlist UX and architecture without destabilizing the canonical Hearth v2 product.
- Target users: Maintainers and collaborators testing structural changes prior to canonical adoption.
...
- Production app: 
- Staging app: N/A
- Repository: https://github.com/BenWassa/template-hearth
- Main branch: https://github.com/BenWassa/template-hearth/tree/main
- Active working branch: https://github.com/BenWassa/template-hearth/tree/main
- Docs: https://github.com/BenWassa/template-hearth/blob/main/README.md
- Design files: N/A
- Issue tracker / board: https://github.com/BenWassa/template-hearth/issues
...
```text
You are helping on Hearth template repo (template-hearth).
...
- Public tagline: Prototype with guardrails before production.
