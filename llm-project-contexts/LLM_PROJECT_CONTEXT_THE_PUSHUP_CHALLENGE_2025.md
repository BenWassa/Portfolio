# PushUp Challenge LLM Project Context (the-pushup-challenge-2025)

Use this as `LLM_CONTEXT.md` when handing PushUp Challenge to another LLM.

## 1) Project Snapshot
- Project name: PushUp Challenge
- One-line description: A challenge-specific fitness app for accountable daily tracking and community momentum.
- Current status: `active`
- Primary owner: Benjamin Haddon
- Last updated (YYYY-MM-DD): 2026-02-18

## 2) Purpose and Scope
- Problem this project solves: Short-term fitness challenges fail when participants cannot see progress clearly or stay accountable.
- Target users: Participants in structured pushup challenges and small competitive cohorts.
- Core outcomes / success criteria:
  - Track daily completion cleanly.
  - Support leaderboard visibility and accountability.
  - Keep challenge mode lightweight and motivating.
- In scope:
  - Daily logging, challenge progress, and ranking views.
  - Mobile-friendly entry and review flows.
  - Demo-friendly portfolio mode.
- Out of scope:
  - Generic all-purpose workout planning.
...
- Docs: https://github.com/BenWassa/the-pushup-challenge-2025/blob/main/README.md
- Design files: N/A
- Issue tracker / board: https://github.com/BenWassa/the-pushup-challenge-2025/issues
...
```text
You are helping on PushUp Challenge (the-pushup-challenge-2025).
...
- Public tagline: A focused system for finishing the challenge strong.
...
- Resume bullet: Built and iterated PushUp Challenge as a focused product with strong UX intent and technical clarity
