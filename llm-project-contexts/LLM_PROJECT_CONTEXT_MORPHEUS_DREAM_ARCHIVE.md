# Morpheus LLM Project Context (morpheus-dream-archive)

Use this as `LLM_CONTEXT.md` when handing Morpheus to another LLM.

## 1) Project Snapshot
- Project name: Morpheus
- One-line description: A dream archive for serious reflection, pattern tracking, and long-horizon self-observation.
- Current status: `prototype`
- Primary owner: Benjamin Haddon
- Public access mode: `private_personal` (contains personal/private context; not intended as public portfolio route)
- Last updated (YYYY-MM-DD): 2026-01-26

## 2) Purpose and Scope
- Problem this project solves: Dream capture is usually ad hoc; users need a structured, private archive for meaningful reflection.
- Target users: Writers, reflective practitioners, and psychology-curious users logging dream material.
- Core outcomes / success criteria:
  - Make capture immediate and low-friction.
  - Preserve entries in a private long-term archive.
  - Support thematic review over time.
- In scope:
  - Dream logging and archive structure.
  - Search/review-friendly organization.
  - Personal reflection workflows.
- Out of scope:
  - Medical interpretation claims.
  - Social sharing-first dynamics.

## 3) Links (Use Full URLs)
- Production app: https://benwassa.github.io/morpheus-dream-archive/
- Staging app: N/A
- Repository: https://github.com/BenWassa/morpheus-dream-archive
- Main branch: https://github.com/BenWassa/morpheus-dream-archive/tree/main
- Active working branch: https://github.com/BenWassa/morpheus-dream-archive/tree/main
- Docs: https://github.com/BenWassa/morpheus-dream-archive/blob/main/README.md
- Design files: N/A
- Issue tracker / board: https://github.com/BenWassa/morpheus-dream-archive/issues
...
- Blockers:
  - This repo is in an edge-case family. Canonical source will be selected in second pass.
...
```text
You are helping on Morpheus (morpheus-dream-archive).
...
- Public tagline: Treat dreams as signal, not noise.
...
- Resume bullet: Built and iterated Morpheus as a focused product with strong UX intent and technical clarity
