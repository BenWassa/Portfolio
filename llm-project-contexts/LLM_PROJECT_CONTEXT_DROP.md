# drop LLM Project Context (drop)

Use this as `LLM_CONTEXT.md` when handing drop to another LLM.

## 1) Project Snapshot
- Project name: drop
- One-line description: An offline-first daily domains tracker built for consistency, realism, and long-horizon growth.
- Current status: `active`
- Primary owner: Benjamin Haddon
- Last updated (YYYY-MM-DD): 2026-02-18

## 2) Purpose and Scope
- Problem this project solves: Most habit apps optimize streak pressure instead of honest reflection and sustainable improvement.
- Target users: People tracking sleep, fitness, mind, and spirit without social pressure or account lock-in.
- Core outcomes / success criteria:
  - Make daily logging frictionless.
  - Reward consistency over perfection.
  - Preserve user privacy with local-first storage.
- In scope:
  - Offline PWA tracking and trend visibility.
  - Local backup and history editing.
  - Mobile-first UX with low cognitive load.
- Out of scope:
  - Social feeds or leaderboards.
  - Cloud-first personal data mining.

## 3) Links (Use Full URLs)
- Production app: https://benwassa.github.io/drop/
- Staging app: N/A
- Repository: https://github.com/BenWassa/drop
- Main branch: https://github.com/BenWassa/drop/tree/main
- Active working branch: https://github.com/BenWassa/drop/tree/main
- Docs: https://github.com/BenWassa/drop/blob/main/README.md
- Design files: N/A
- Issue tracker / board: https://github.com/BenWassa/drop/issues
...
- Public tagline: A quality tracker, not a streak machine.
...
- Resume bullet: Built and iterated drop as a focused product with strong UX intent and technical clarity
