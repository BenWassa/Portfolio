# Morpheus LLM Project Context (template-morpheus)
...
- Public access mode: `public_template` (public-safe template route; canonical private data remains protected)
- Last updated (YYYY-MM-DD): 2026-01-30
...
- Production app: 
- Staging app: N/A
- Repository: https://github.com/BenWassa/template-morpheus
- Main branch: https://github.com/BenWassa/template-morpheus/tree/main
- Active working branch: https://github.com/BenWassa/template-morpheus/tree/main
- Docs: https://github.com/BenWassa/template-morpheus/blob/main/README.md
- Design files: N/A
- Issue tracker / board: https://github.com/BenWassa/template-morpheus/issues
...
```text
You are helping on Morpheus (template-morpheus).
