# Vox LLM Project Context (Vox_Showcase)

Use this as `LLM_CONTEXT.md` when handing Vox to another LLM.

## 1) Project Snapshot
- Project name: Vox
- One-line description: An offline-first language study system for deliberate vocabulary and grammar growth.
- Current status: `prototype`
- Primary owner: Benjamin Haddon
- Public access mode: `public_template` (public-facing showcase used in portfolio; private original remains protected)
- Last updated (YYYY-MM-DD): 2026-02-19

## 2) Purpose and Scope
- Problem this project solves: Mainstream language apps prioritize gamification over transparent skill building.
- Target users: Self-directed learners studying vocabulary, grammar, and practical output.
- Core outcomes / success criteria:
  - Track vocabulary rigorously.
  - Support repeatable daily practice workflows.
  - Keep progress visible and exportable.
- In scope:
  - Local-first vocabulary management.
  - Practice counters and progress views.
  - Simple import/export pathways.
- Out of scope:
  - AI chat companions as the primary learning mode.
  - Engagement-maximizing streak mechanics.

## 3) Links (Use Full URLs)
- Production app: https://benwassa.github.io/Vox_Showcase/
- Staging app: N/A
- Repository: https://github.com/BenWassa/Vox_Showcase
- Main branch: https://github.com/BenWassa/Vox_Showcase/tree/main
- Active working branch: https://github.com/BenWassa/Vox_Showcase/tree/main
- Docs: https://github.com/BenWassa/Vox_Showcase/blob/main/README.md
- Design files: N/A
- Issue tracker / board: https://github.com/BenWassa/Vox_Showcase/issues
...
```text
You are helping on Vox (Vox_Showcase).
...
- Public tagline: Language progress with clarity, not gimmicks.
...
- Resume bullet: Built and iterated Vox as a focused product with strong UX intent and technical clarity
