# Hearth LLM Project Context (hearthMVP)

Use this as `LLM_CONTEXT.md` when handing Hearth to another LLM.

## 1) Project Snapshot
- Project name: Hearth
- One-line description: A shared watchlist experience for couples, optimized for calm decisions and metadata quality.
- Current status: `active`
- Primary owner: Benjamin Haddon
- Public access mode: `private_legacy` (earlier internal/legacy variant; not the current public canonical route)
- Last updated (YYYY-MM-DD): 2026-02-13

## 2) Purpose and Scope
- Problem this project solves: Choosing what to watch becomes exhausting when shared intent is replaced by algorithmic overload.
- Target users: Couples and households curating a shared viewing experience.
- Core outcomes / success criteria:
  - Keep shared shelf data clean and current.
  - Reduce friction in decision flows.
  - Provide reliable demo and production modes.
- In scope:
  - Collaborative watchlist operations.
  - Metadata enrichment and progress tracking.
  - Decision-support interfaces.
- Out of scope:
  - Playback hosting.
  - Social discovery feed features.

## 3) Links (Use Full URLs)
- Production app: https://benwassa.github.io/hearthMVP/
- Staging app: N/A
- Repository: https://github.com/BenWassa/hearthMVP
- Main branch: https://github.com/BenWassa/hearthMVP/tree/main
- Active working branch: https://github.com/BenWassa/hearthMVP/tree/firebase-app-hosting-vnext
- Docs: https://github.com/BenWassa/hearthMVP/blob/main/README.md
- Design files: N/A
- Issue tracker / board: https://github.com/BenWassa/hearthMVP/issues
...
```text
You are helping on Hearth (hearthMVP).
...
- Public tagline: Decide together without the noise.
...
- Resume bullet: Built and iterated Hearth as a focused product with strong UX intent and technical clarity
