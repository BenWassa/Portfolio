# Agoge LLM Project Context (agoge)

Use this as `LLM_CONTEXT.md` when handing Agoge to another LLM.

## 1) Project Snapshot
- Project name: Agoge
- One-line description: A cross-cultural rites-of-passage research project for modern resilience and moral development.
- Current status: `draft`
- Primary owner: Benjamin Haddon
- Last updated (YYYY-MM-DD): 2026-02-18

## 2) Purpose and Scope
- Problem this project solves: Modern life lacks coherent initiation structures that help people mature with responsibility and belonging.
- Target users: Researchers, educators, and builders of developmental programs for youth and adults.
- Core outcomes / success criteria:
  - Synthesize rites-of-passage models across cultures.
  - Translate tradition into modern ethical practice.
  - Build a narrative foundation for podcast and curriculum formats.
- In scope:
  - Historical and mythic analysis.
  - Psychological framing and practical adaptation.
  - Long-form narrative outputs.
- Out of scope:
  - Rigid ideological prescriptions.
  - One-size-fits-all identity frameworks.

## 3) Links (Use Full URLs)
- Production app: https://benwassa.github.io/agoge/
- Staging app: N/A
- Repository: https://github.com/BenWassa/agoge
- Main branch: https://github.com/BenWassa/agoge/tree/main
- Active working branch: https://github.com/BenWassa/agoge/tree/main
- Docs: https://github.com/BenWassa/agoge/blob/main/README.md
- Design files: N/A
- Issue tracker / board: https://github.com/BenWassa/agoge/issues
...
```text
You are helping on Agoge (agoge).
...
- Public tagline: Rebuilding initiation for a world without rites.
...
- Resume bullet: Built and iterated Agoge as a focused product with strong UX intent and technical clarity
