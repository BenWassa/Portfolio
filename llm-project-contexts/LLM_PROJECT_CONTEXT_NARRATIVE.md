# Narrative LLM Project Context (Narrative)

Use this as `LLM_CONTEXT.md` when handing Narrative to another LLM.

## 1) Project Snapshot
- Project name: Narrative
- One-line description: A local-first travel media organizer that sorts by story role rather than chronology.
- Current status: `active`
- Primary owner: Benjamin Haddon
- Last updated (YYYY-MM-DD): 2026-02-18

## 2) Purpose and Scope
- Problem this project solves: Chronological photo tools make story construction slow and cognitively expensive.
- Target users: Travelers and creators who want fast narrative editing of image/video libraries.
- Core outcomes / success criteria:
  - Accelerate media triage.
  - Preserve a coherent story arc.
  - Keep workflow private and offline-friendly.
- In scope:
  - Story-role categorization and rapid sorting.
  - Local processing and lightweight review UX.
  - Export-ready organization for sharing.
- Out of scope:
  - Cloud collaboration suites.
  - Heavyweight DAM complexity.

## 3) Links (Use Full URLs)
- Production app: https://benwassa.github.io/Narrative/
- Staging app: N/A
- Repository: https://github.com/BenWassa/Narrative
- Main branch: https://github.com/BenWassa/Narrative/tree/main
- Active working branch: https://github.com/BenWassa/Narrative/tree/main
- Docs: https://github.com/BenWassa/Narrative/blob/main/README.md
- Design files: N/A
- Issue tracker / board: https://github.com/BenWassa/Narrative/issues
...
```text
You are helping on Narrative (Narrative).
...
- Public tagline: Organize memories like a story, not a timestamp dump.
...
- Resume bullet: Built and iterated Narrative as a focused product with strong UX intent and technical clarity
