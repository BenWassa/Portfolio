# Punchbuggy LLM Project Context (punchbuggy)

Use this as `LLM_CONTEXT.md` when handing Punchbuggy to another LLM.

## 1) Project Snapshot
- Project name: Punchbuggy
- One-line description: A minimalist game PWA designed for immediate feedback and pure play.
- Current status: `active`
- Primary owner: Benjamin Haddon
- Last updated (YYYY-MM-DD): 2026-02-18

## 2) Purpose and Scope
- Problem this project solves: Many games optimize addiction loops instead of short, honest moments of delight.
- Target users: Players who want fast, lightweight, replayable fun without bloat.
- Core outcomes / success criteria:
  - Instant response and low friction.
  - Strong feel despite minimal mechanics.
  - Installable and offline-capable experience.
- In scope:
  - Core game loop and micro-interaction polish.
  - PWA installability and quick load behavior.
  - Simple visual identity.
- Out of scope:
  - Account systems.
  - Monetization funnels or dark patterns.
...
- Docs: https://github.com/BenWassa/punchbuggy/blob/main/README.md
- Design files: N/A
- Issue tracker / board: https://github.com/BenWassa/punchbuggy/issues
...
```text
You are helping on Punchbuggy (punchbuggy).
...
- Public tagline: No punchbacks. Just play.
...
- Resume bullet: Built and iterated Punchbuggy as a focused product with strong UX intent and technical clarity
