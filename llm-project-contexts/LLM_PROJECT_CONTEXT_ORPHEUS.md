# Orpheus LLM Project Context (orpheus)

Use this as `LLM_CONTEXT.md` when handing Orpheus to another LLM.

## 1) Project Snapshot
- Project name: Orpheus
- One-line description: A music-intelligence project that maps emotional patterns through listening behavior.
- Current status: `draft`
- Primary owner: Benjamin Haddon
- Public access mode: `not_live` (intentionally not public yet; portfolio card remains non-linking by design)
- Last updated (YYYY-MM-DD): 2026-02-18

## 2) Purpose and Scope
- Problem this project solves: Music habits carry psychological signal, but most tools treat listening history as disposable entertainment data.
- Target users: Reflective listeners, creators, and psychologically curious users.
- Core outcomes / success criteria:
  - Turn replay patterns into interpretable themes.
  - Support introspection without reducing experience to metrics.
  - Bridge lyrical meaning with behavioral signal.
- In scope:
  - Listening-pattern interpretation.
  - Reflective prompts and narrative framing.
...
- Production app: https://benwassa.github.io/orpheus/
- Staging app: N/A
- Repository: https://github.com/BenWassa/orpheus
- Main branch: https://github.com/BenWassa/orpheus/tree/main
- Active working branch: https://github.com/BenWassa/orpheus/tree/main
- Docs: https://github.com/BenWassa/orpheus/blob/main/README.md
- Design files: N/A
- Issue tracker / board: https://github.com/BenWassa/orpheus/issues
...
```text
You are helping on Orpheus (orpheus).
...
- Public tagline: Read your emotional arc through the songs you repeat.
...
- Resume bullet: Built and iterated Orpheus as a focused product with strong UX intent and technical clarity
